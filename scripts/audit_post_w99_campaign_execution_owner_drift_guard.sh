...
grep -q 'service_post_w99_campaign_attention_actionability_app' src/binario_marketing/service_post_w99_campaign_execution_owner_drift_guard_app.py
...
grep -q 'owner_drift_runs_after_campaign_actionability_filters' src/binario_marketing/service_post_w99_campaign_execution_owner_drift_guard_app.py
grep -q 'path == "/campaign-attention-actionability.js"' src/binario_marketing/service_post_w99_campaign_execution_owner_drift_guard_app.py
