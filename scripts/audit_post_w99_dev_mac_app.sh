...
/usr/bin/grep -q 'AI_HANDOFF' "$RESOURCES/source/src/binario_marketing/ai_recommendation_handoff.py"
/usr/bin/grep -q 'rank=87' "$RESOURCES/source/src/binario_marketing/ai_recommendation_handoff.py"
/usr/bin/grep -q 'owner_from_structured_fields_only' "$RESOURCES/source/src/binario_marketing/ai_recommendation_handoff.py"
...
/usr/bin/grep -q 'POST_W99_AI_RECOMMENDATION_HANDOFF' "$RESOURCES/source/web/ai-recommendation-handoff.js"
/usr/bin/grep -q 'ai-accepted-handoff' "$RESOURCES/source/web/ai-recommendation-handoff.js"
/usr/bin/grep -q 'Marcar aplicada' "$RESOURCES/source/web/ai-recommendation-handoff.js"
/usr/bin/grep -q 'No aplicar' "$RESOURCES/source/web/ai-recommendation-handoff.js"
/usr/bin/grep -q 'window.confirm' "$RESOURCES/source/web/ai-recommendation-handoff.js"
/usr/bin/grep -q "method:'POST'" "$RESOURCES/source/web/ai-recommendation-handoff.js"
! /usr/bin/grep -q 'setInterval' "$RESOURCES/source/web/ai-recommendation-handoff.js"
! /usr/bin/grep -q 'setTimeout' "$RESOURCES/source/web/ai-recommendation-handoff.js"
! /usr/bin/grep -q 'MutationObserver' "$RESOURCES/source/web/ai-recommendation-handoff.js"
