...
[[ -f "$RESOURCES/source/src/binario_marketing/results_freshness.py" ]] || fail "post-W99 results freshness core is missing from packaged source"
[[ -f "$RESOURCES/source/src/binario_marketing/service_post_w99_results_freshness_guard_app.py" ]] || fail "post-W99 results freshness terminal is missing from packaged source"
[[ -f "$RESOURCES/source/src/binario_marketing/ai_recommendation_review.py" ]] || fail "post-W99 AI recommendation review core is missing from packaged source"
[[ -f "$RESOURCES/source/src/binario_marketing/service_post_w99_ai_recommendation_review_app.py" ]] || fail "post-W99 AI recommendation review terminal is missing from packaged source"
[[ -f "$RESOURCES/source/src/binario_marketing/ai_recommendation_handoff.py" ]] || fail "post-W99 AI accepted handoff core is missing from packaged source"
[[ -f "$RESOURCES/source/src/binario_marketing/service_post_w99_ai_recommendation_handoff_app.py" ]] || fail "post-W99 AI accepted handoff terminal is missing from packaged source"
[[ -f "$RESOURCES/source/src/binario_marketing/ai_recommendation_evidence.py" ]] || fail "post-W99 AI recommendation evidence core is missing from packaged source"
[[ -f "$RESOURCES/source/src/binario_marketing/service_post_w99_ai_recommendation_evidence_app.py" ]] || fail "post-W99 AI recommendation evidence terminal is missing from packaged source"
[[ -f "$RESOURCES/source/src/binario_marketing/ai_human_feedback_context.py" ]] || fail "post-W99 AI human feedback context core is missing from packaged source"
...
[[ -f "$RESOURCES/source/src/binario_marketing/portfolio_crm.py" ]] || fail "post-W99 portfolio CRM core is missing from packaged source"
[[ -f "$RESOURCES/source/src/binario_marketing/service_post_w99_portfolio_crm_app.py" ]] || fail "post-W99 portfolio CRM terminal is missing from packaged source"
...
[[ -f "$RESOURCES/source/web/ai-recommendation-review.js" ]] || fail "post-W99 AI recommendation review browser adapter is missing from packaged source"
...
[[ -f "$RESOURCES/source/web/portfolio-crm.js" ]] || fail "post-W99 portfolio CRM browser surface is missing from packaged source"
