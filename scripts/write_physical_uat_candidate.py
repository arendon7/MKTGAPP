...
def main() -> int:
    ...
    print(json.dumps({
        "schema": manifest["schema"], "role": manifest["role"], "git_sha": manifest["git_sha"],
        "candidate_source_sha256": manifest["candidate_source_sha256"], "runtime_wave": manifest["runtime_wave"],
        "architecture": manifest["architecture"], "build_origin": manifest["build_origin"], "verified": bool(args.verify),
