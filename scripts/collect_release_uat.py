...
def render_markdown(report: dict[str, Any]) -> str:
    ...
    lines += [
        ...
        "## Rule",
        "",
        "Este archivo se genera inicialmente con `uat_passed=false`. UAT solo puede considerarse PASS cuando todos los gates manuales se ejecuten sobre este mismo SHA, digest de fuente y candidato arm64.",
...
def main() -> int:
    ...
    print(json.dumps({"overall": report["overall"], "output": str(out), "git_sha": report["git_sha"], "candidate_source_sha256": report["candidate_source_sha256"], "architecture": report["architecture"]}, ensure_ascii=False, indent=2))
