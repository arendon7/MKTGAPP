...
Physical UAT evidence must come from the exact non-CI arm64 candidate established by W81. The safe transport of that evidence into a later tag build is a separate release-engineering problem. W82 deliberately refuses to invent or simulate that evidence transport.
