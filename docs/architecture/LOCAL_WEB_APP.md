...
The reconstructed canonical source now includes a dependency-free local HTTP service and a versioned browser UI.
...
1. create project;
2. import an existing local file into managed assets;
...
The browser UI uses the same JSON API covered by end-to-end HTTP tests.
