...
`service_post_w99_campaign_creative_creation_intent_handoff_app` es ahora el terminal de composición de `serve-dev`. La ascendencia explícita de las capas superiores es:
