...
class AppRuntime(base.AppRuntime):
    """Expose owner drift after campaign actionability filters preserve canonical work semantics."""
...
class MarketingHandler(base.MarketingHandler):
    """Load a zero-transport owner-drift browser guard after campaign attention actionability."""
