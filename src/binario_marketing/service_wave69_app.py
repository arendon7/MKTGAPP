...
class AppRuntime(base.AppRuntime):
    ...
    def _trusted_physical_uat_candidate(candidate: dict, build: dict) -> bool:
        ...
        trusted_ref = ref == "refs/heads/main" or ref.startswith("refs/tags/v")
        return bool(
            ...
            and candidate.get("certification_guard_wave") == 83
    ...
    def physical_uat_preflight(self, company_id: str) -> dict:
        ...
        executable_runtime = all(path.is_file() and os.access(path, os.X_OK) for key, path in paths.items() if key != "whisper_manifest")
        ...
        return {
            ...
            "build": build,
            "candidate": {
                "schema": candidate.get("schema"), "role": candidate.get("role"), "git_sha": candidate.get("git_sha"),
                "candidate_source_sha256": candidate.get("candidate_source_sha256"), "build_origin": origin,
            ...
            "release_boundary": {"version": __version__, "release_ready": RELEASE_READY, "release_tag": RELEASE_TAG, "production_ready": False, "physical_preflight_is_release_authority": False},
