...
class AppRuntime(base.AppRuntime):
    """Preserve the current dev chain while hardening W64 MEDIA identity semantics."""
...
class MarketingHandler(base.MarketingHandler):
    """Append the browser-only submit invariant after the current last browser owner layer."""
